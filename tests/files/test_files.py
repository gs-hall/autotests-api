...
from tools.assertions.files import assert_create_file_response, assert_create_file_with_empty_directory_response, assert_create_file_with_empty_filename_response, assert_file_not_found_response, assert_get_file_response
...
class TestFiles:
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient):
        """
        Негативный тест: запрос файла с некорректным file_id должен вернуть ошибку валидации.
        """
